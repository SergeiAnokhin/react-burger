...
export const constructorReducer = (state = initialState, action) => {
    switch(action.type) {
      ...
      case ADD_INGREDIENT:
        return {...state, ingredients: [...state.ingredients, action.payload], allIngredientsId: [state.allIngredientsId[0], ...state.ingredients.map(item => item._id), action.payload._id, state.allIngredientsId[state.allIngredientsId.length - 1]]}
      case DELETE_INGREDIENT:
        return {...state, 
          ...
          allIngredientsId: [state.allIngredientsId[0], ...state.allIngredientsId.slice(1, state.allIngredientsId.findIndex(item => item === action.payload)), 
